...
### 3.7 Pushbutton & LED
![Push button with LED](https://m.media-amazon.com/images/I/51t2agCBdrL._AC_SL1100_.jpg)
...
### 3.8 Opto-coupler
Here I'm using a common optocoupler called 4N25. it's a generic one. there's nothing special about the optoccoupler.
...
I used these combo, BTB26-600 as the TRIAC and the TRIAC coupler is MOC3020M. So basically the MCU will control the TRIAC Coupler and TRIAC coupler will drive the TRIAC.  Instead of driving the TRIAC directly will provide an isolation to the circuit which is good practice and if you are new to TRIAC it is fascinating device 
#### specification
|Attributes                   | Description  |
|:----------------------------|-------------:|
|         IT(RMS)   	        |25A           |
