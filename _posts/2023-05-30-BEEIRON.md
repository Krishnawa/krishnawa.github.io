...
Here I'm using a common optocoupler called 4N25. it's a generic one. there's nothing special about this optoccoupler, that combines an infrared LED and a phototransistor. It allows electrical isolation between two circuits while transmitting signals through light.
...
I used these combo, BTB26-600 as the TRIAC and the TRIAC coupler is MOC3020M. So basically the MCU will control the TRIAC Coupler and TRIAC coupler will trigger the TRIAC.  Instead of driving the TRIAC directly,we will provide an isolation to the circuit which is good practice and if you are new to TRIAC and DIAC it is fascinating devices, Maybe it's an another topic for an another blog!.
...
The MOC301XM and MOC302XM series are optically isolated TRIAC driver devices. These devices contain a GaAs infrared emitting diode and a light activated silicon bilateral switch, which functions like a TRIAC. They are designed for interfacing between electronic controls and power TRIAC to control resistive and inductive loads for 115 VAC operations. This particular TRIAC coupler is random phase trigger not a zero cross phase trigger!

#### Specification of MOC3020M
![TRIAC COUPLER](https://my.element14.com/productimages/standard/en_GB/1471017-40.jpg){: lqip="https://my.element14.com/productimages/standard/en_GB/1471017-40.jpg"}{: .right}{: w="300" h="300" }
_MOC3020M_
